...
export const patientsMock: Patient[] = [
  {
    ...
    ownerName: 'Cooper Robinson',
    ownerPhone: '+54 9 11 5555-0101',
    status: 'active',
    treatments: [
  ...
  },
  {
    ...
    ownerName: 'Lucy Perkins',
    ownerPhone: '+54 9 11 5555-0102',
    status: 'active',
